...
# 在脚本开始前询问我源文件夹位置（默认地址：d:\Works\Downloads\）与目标文件位置（默认地址：e:\Documents\Creations\Scripts\Attachments\Python\Ed2kList.txt）。
...
def main():
    ...
    try:
        ...
        # 询问目标文件位置
        default_target = r"e:\Documents\Creations\Scripts\Attachments\Python\Ed2kList.txt"
